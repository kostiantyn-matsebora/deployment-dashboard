...
/// </summary>
/// <remarks>
/// Layering: appsettings <c>GitHub</c> section = base; flat <c>GITHUB_*</c> env vars = override.
/// Each var overrides only when present AND parseable; absent or unparseable values leave the
/// bound/default value untouched and do not throw. Empty string is skipped for string fields.
/// </remarks>
public static class GithubAdapterOptionsEnv
{
    /// <summary>
    /// Reads the documented flat <c>GITHUB_*</c> env vars from <paramref name="config"/>
