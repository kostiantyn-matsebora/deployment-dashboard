...
{
    /// <summary>
    /// Reads <c>RESET_ACK_TIMEOUT_SECONDS</c>, <c>RESET_GATE_MAX_TTL_SECONDS</c>, and
    /// <c>RESET_EXPECTED_COMPONENTS</c> from <paramref name="config"/> and applies any valid
    /// values to <paramref name="options"/> in place.
    /// </summary>
