...
9. **Sibling README.md classification.** For every `README.md` encountered during the descent (target dir or any descended sub-dir without `index.md`), apply the binding classification from `.claude/agents/document-writer.md` § "README.md classification":
