...
7. `.agents/ginee/local/roles/solution-architect.md` — project-local extension (load if present; augments the cardinal charter with project-specific craft notes)
