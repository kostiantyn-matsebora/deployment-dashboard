...
5. `.agents/ginee/local/roles/backend-engineer.md` — project-local extension (load if present; augments the cardinal charter with project-specific craft notes)
