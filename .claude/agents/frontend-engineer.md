...
5. `.agents/ginee/local/roles/frontend-engineer.md` — project-local extension (load if present; augments the cardinal charter with project-specific craft notes)
