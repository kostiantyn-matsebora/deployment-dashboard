...
- **Emit the typed form verbatim** — `RESULT` / `ARTIFACT` (settled interface) / `REVIEW` (reviewing) / `FINDING` (blocked); skeletons in [`../process.md`](../process.md) *Hand-back templates*. No extra fields; ≤3 notes.
