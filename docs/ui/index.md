...
Mockup-supporting design records for per-option proposals. The canonical visual contract is `deployment-dashboard.html` (binary, not rendered in this site).
...
| [Version-Display Options](./version-display-options.md) | Phase 2 - giving the `version` attribute room without breaking geometric contracts |
