...
>
> The mockup (`docs/ui/deployment-dashboard.html`) is the visual contract; the responsiveness invariant in NFR-09 (including the two sibling invariants in §5) is the geometric guarantee under any expand/collapse state in any layout.
