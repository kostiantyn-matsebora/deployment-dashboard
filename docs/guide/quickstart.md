...
To pin to a specific release, replace `main` in the URLs with the release tag (e.g. `.../v0.2.0/compose/...`) and set `DASHBOARD_VERSION=0.2.0` for a reproducible deploy — see [Pinning a release version](./install.md#pinning-a-release-version).
