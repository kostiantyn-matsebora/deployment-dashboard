...
[![C4 component diagram of the Deployment Dashboard runtime](../diagrams/architecture-c4.svg)](../diagrams/architecture-c4.svg)

*Editable source: [`architecture-c4.drawio`](../diagrams/architecture-c4.drawio). A diff-friendly [Mermaid version](../diagrams/architecture-c4.md) is also maintained.*
