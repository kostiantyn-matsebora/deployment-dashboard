...
> Prefer pull mode over editing every workflow? The optional **Fetcher** polls the GitHub Actions API and posts for you — see [Install § pull mode](./install.md#deployment-shapes-compose-profiles) and the [Fetcher spec](../FETCHER_SPECIFICATION.md).
