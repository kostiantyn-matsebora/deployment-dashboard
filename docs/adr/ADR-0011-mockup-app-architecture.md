...
- **References.**
  ...
  - **CR-0015** (team-lead-authored, paired with this ADR; amended 2026-05-25 to match this ADR amendment) — source-of-truth pivot governance: `local/framework.config.yaml § mockup-spa` addition, `local/bindings.md § mockup/` row, retirement plan handoff to sibling issue #80.
