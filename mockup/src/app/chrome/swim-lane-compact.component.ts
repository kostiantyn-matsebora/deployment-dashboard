// Swim-lane × Compact — copy of swim-lane-detailed with DeploymentCompactComponent + 140×90 nodes.
...
@Component({
  selector: 'dd-mockup-swim-lane-compact',
  standalone: true,
  ...
  `],
  template: `
    <main class="px-6 pt-4 pb-8" data-testid="pipeline-matrix" data-view="compact" data-layout="swim-lane">
      <div class="space-y-2">
                ...
                <div class="ngx-graph-container">
                  ...
                  >
                    <ng-template #defsTemplate>
                      <svg:marker id="compact-arrow" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="8" markerHeight="8" orient="auto">
                    ...
                    <ng-template #linkTemplate let-link>
                      <svg:g class="edge">
                        <svg:path class="line" stroke-width="1.5" marker-end="url(#compact-arrow)" [class.edge-correlated]="link.data?.source === 'correlated'" />
                      </svg:g>
                    </ng-template>
                  </ngx-graph>
                </div>
...
export class SwimLaneCompactComponent {
  ...
  graphFor(svc: ServiceWithDeployments): ServiceGraph {
    ...
    return {
      nodes: dag.nodes.map(n => ({ ...n, dimension: { width: 140, height: 90 } })),
      links: dag.edges
    };
  }
